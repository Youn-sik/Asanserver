...
function import_data() {
	...
	do
		...
		if [ -n "$g_home_list__name" ] && [ -n "$g_home_list__update_time" ] && [ -n "$g_home_list__g_home_stb_sn" ]; then
			echo "INSERT INTO $db_table_g_home_list VALUES (DEFAULT, '$g_home_list__name', '$g_home_list__update_time', '$g_home_list__g_home_stb_sn');"
		fi
		...
		if [ -n "$g_instrument__thumbnail" ] && [ -n "$g_instrument__name" ] && [ -n "$g_instrument__contents" ]; then
			...
			echo "INSERT INTO $db_table_g_surgery VALUES (DEFAULT, '$g_surgery__name', '$g_surgery__update_time', '$g_surgery__g_main_home_stb_sn');"
                fi
			...
			echo "INSERT INTO $db_table_g_patient VALUES (DEFAULT, '$g_patient__name', '$g_patient__gender', '$g_patient__age', '$g_patient__dob', '$g_patient__surgicalsite', '$g_patient__g_surgery_uid', '$g_patient__surgicalname', '$g_patient__g_main_home_stb_sn');"
                fi
